...
import spl_token_source from './keypair1.json';
        ...
        <main>
            <MainContainer >
                ...
                <div className="scroll" style={{ display: 'flex', overflowX: 'scroll', position: 'relative', backgroundColor: '#1A1D1F', padding: '20px', borderRadius: '15px' }}>
                    ...
                    {
                        nftList?.length == 0 &&
                        <span style={{ fontSize: 20 }}>No Hellcats found, purchase here: https://magiceden.io/</span>
                    }
                </div>
                ...
                <MintContainer style={{ backgroundColor: '#1A1D1F', borderRadius: '30px', marginTop: '3%' }}>
                    <div style={{ marginTop: '20px' }}>
                        <button className={isAngel ? 'send-btn' : 'send-btn1'} onClick={() => { }}>Overlord Angel</button>
                        <button className={isAngel ? 'send-btn1' : 'send-btn'} onClick={() => { }}>Overlord Demon</button>
